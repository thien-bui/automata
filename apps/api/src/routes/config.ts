...
const configUpdateSchema = z.object({
  weather: z.object({
    ...
    displaySettings: z.object({
      ...
      hourlyForecastHours: z.number().min(1).max(168).optional(),
      hourlyForecastPastHours: z.number().min(0).max(24).optional(),
      hourlyForecastFutureHours: z.number().min(0).max(24).optional(),
      currentHourHighlight: z.boolean().optional(),
      showHumidity: z.boolean().optional(),
      showWindSpeed: z.boolean().optional(),
      showPrecipitation: z.boolean().optional(),
      temperatureUnit: z.enum(['celsius', 'fahrenheit', 'both']).optional(),
    }).optional(),
    uiSettings: z.object({
      compactMode: z.boolean().optional(),
      showCacheInfo: z.boolean().optional(),
  ...
  discord: z.object({
    ...
    maxRefreshSeconds: z.number().min(60).max(3600).optional(),
    displaySettings: z.object({
      showBots: z.boolean().optional(),
      showOfflineMembers: z.boolean().optional(),
      sortBy: z.enum(['status', 'username', 'displayName']).optional(),
      groupByStatus: z.boolean().optional(),
      maxMembersToShow: z.number().min(1).max(1000).optional(),
